...
export default function ProjectCarousel() {
  ...
  const loadingProject: ProjectProps = useMemo(() => { return (projects[0]) }, [projects])
  ...
  return (
    ...
    >
      ...
      >
        <iframe src={showProject?.url ? showProject.url : loadingProject?.url} width="100%" height="100%"></iframe>
        <div
          style={{
            position: 'absolute',
            bottom: '0',
